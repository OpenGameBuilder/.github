...
ASP.NET Core is a framework for building web applications and APIs with .NET.
These links cover its fundamentals and related tools; see also the
...
- [What's new in ASP.NET Core 11](https://learn.microsoft.com/en-us/aspnet/core/release-notes/aspnetcore-11?view=aspnetcore-10.0)
